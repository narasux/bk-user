    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '等待'), ('running', '执行中'), ('success', '成功'), ('failed', '失败'), ('skipped', '跳过')], max_length=32, verbose_name='任务总状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.CharField(choices=[('create', '创建'), ('update', '更新'), ('delete', '删除'), ('restore', '恢复')], max_length=32, verbose_name='操作类型')),
